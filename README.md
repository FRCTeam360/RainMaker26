...
This project contains robot code for FRC 360's 2026 robot, RainMaker26. See 360's Open Alliance [build thread](https://www.chiefdelphi.com/t/frc-360-the-revolution-2026-build-thread-open-alliance/510290) on Chief Delphi to follow our progress.
...
- [ ] Build: `./gradlew build`
- [ ] Deploy to robot: `./gradlew deploy` (when connected to robot)
