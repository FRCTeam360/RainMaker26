...
public class HopperSensorIOCB implements HopperSensorIO {
  ...
  private final CANrange canRange =
      new CANrange(Constants.CompBotConstants.HOPPER_SENSOR_ID, Constants.CompBotConstants.CANBUS);

  private final StatusSignal<Distance> distanceSignal;
  private final StatusSignal<Boolean> isDetectedSignal;

  public HopperSensorIOCB() {
