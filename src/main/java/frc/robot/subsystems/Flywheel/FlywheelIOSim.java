...
public class FlywheelIOSim implements FlywheelIO {
  ...
  // private final LoggedNetworkNumber tunableKp = new LoggedNetworkNumber("/Tuning/Flywheel/kP", 1.0);
  // private final LoggedNetworkNumber tunableKi = new LoggedNetworkNumber("/Tuning/Flywheel/kI", 0.0);
  // private final LoggedNetworkNumber tunableKd = new LoggedNetworkNumber("/Tuning/Flywheel/kD", 0.0);
  private final LoggedNetworkNumber tunableSetpoint = new LoggedNetworkNumber("/Tuning/Flywheel/SetpointRPM", 0.0);
  private final LoggedNetworkBoolean tuningEnabled = new LoggedNetworkBoolean("/Tuning/Flywheel/Enabled", false);
  ...
  public FlywheelIOSim() {
    ...
    motorControllerSim1.getSimState().setRotorVelocity(
        RotationsPerSecond.of(flywheelSim.getAngularVelocityRPM() / 60.0).in(RotationsPerSecond));
    motorControllerSim2.getSimState().setRotorVelocity(
        RotationsPerSecond.of(flywheelSim.getAngularVelocityRPM() / 60.0).in(RotationsPerSecond));
  }
