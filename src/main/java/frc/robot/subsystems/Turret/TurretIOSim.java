...
public class TurretIOSim implements TurretIO {
  ...
  public TurretIOSim() {
    ...
    motorControllerSim
        .getSimState()
        .setRawRotorPosition(Radians.of(TurretSim.getAngleRads() * gearRatio).in(Rotations));
    motorControllerSim
        .getSimState()
        .setRotorVelocity(
            RadiansPerSecond.of(TurretSim.getVelocityRadPerSec() * gearRatio)
  ...
  public void updateInputs(TurretIOInputs inputs) {
    ...
    TurretSim.setInput(motorControllerSim.getSimState().getMotorVoltage());
  ...
  public void setEncoder(double position) {
    ((TurretIO) motorControllerSim).setEncoder(position);
  }
}
