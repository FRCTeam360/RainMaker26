...
public class ClimberIOCB implements ClimberIO {
  ...
  private final SparkMax leftClimberMotor =
      new SparkMax(CompBotConstants.CLIMBER_LEFT_ID, MotorType.kBrushless);
  private final SparkMax rightClimberMotor =
      new SparkMax(CompBotConstants.CLIMBER_RIGHT_ID, MotorType.kBrushless);
  ...
  private static final double FORWARD_SOFT_LIMIT_INCHES = 36.0;//value from comp bot??
